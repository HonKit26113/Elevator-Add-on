...
const articleMap: Article[] = [];

export function showHelpMenu(player: Player) {
...
function showArticle(player: Player, article: Article) {
...
const guidebookData: GuidebookSection[] = [
    {
